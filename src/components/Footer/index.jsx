export const Footer = () => {
  ...
  return (
    <footer
      className="w-full border-t bg-soft-bg border-brand-deep/20 dark:border-brand-deep/20 p-6"
    >
      <div className="max-w-6xl mx-auto px-6 h-20 flex flex-col md:flex-row justify-between items-center gap-4">
        <div>
